...
admin.site.site_header = "Buy"
admin.site.site_title = "Buy Admin Portal"
admin.site.index_title = "Buy Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Buy API",
        default_version="v1",
        description="API documentation for Buy App",
    ),
    public=True,
